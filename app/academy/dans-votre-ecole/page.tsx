      ...
      <section className="relative overflow-hidden bg-[#021d47] py-20 text-white sm:py-28">
        ...
        <div className="container-custom relative">
          ...
          <div className="mt-5 grid gap-12 lg:grid-cols-[1.1fr_.9fr] lg:items-end">
            <div>
              <h1 className="max-w-4xl text-5xl font-semibold leading-[1.07] tracking-[-.04em] sm:text-6xl">NAYGAL ACADEMY dans votre école.</h1>
      ...
      <section className="bg-white py-12">
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-[#032965]">NAYGAL ACADEMY dans votre école — images & ambiances</h2>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { src: '/images/academy/dans-votre-ecole/Galerie/Atelier : élèves en groupe.jpeg', alt: "Élèves africains en atelier", caption: 'Atelier : élèves en groupe'},
              { src: '/images/academy/dans-votre-ecole/Galerie/Classe locale en pleine activité.jpeg', alt: 'Classe en Afrique', caption: 'Classe locale en pleine activité'},
              { src: '/images/academy/dans-votre-ecole/Galerie/Apprentissage et curiosité.jpeg', alt: 'Enfants africains apprenant', caption: 'Apprentissage et curiosité'},
              { src: '/images/academy/dans-votre-ecole/Galerie/Workshop : pratique et partage.webp', alt: 'Atelier pratique en Afrique', caption: 'Workshop : pratique et partage'},
              { src: '/images/academy/dans-votre-ecole/Galerie/Encadrement pédagogique local.jpg', alt: 'Formateur africain', caption: 'Encadrement pédagogique local'},
              { src: '/images/academy/dans-votre-ecole/Galerie/Initiation aux outils numériques.jpeg', alt: 'Usage de technologies en Afrique', caption: 'Initiation aux outils numériques'},
            ].map((img) => (
      ...
      <section className="section-padding">
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">NAYGAL ACADEMY complète le programme scolaire existant par des ateliers pratiques autour des réseaux, de la cybersécurité, de l’intelligence artificielle, du développement et de la robotique.</p>
          </div>
      ...
      <section className="border-t border-slate-100 bg-[#f4f8fd] py-20 sm:py-24">
        <div className="container-custom">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">NAYGAL ACADEMY construit un écosystème de partenaires académiques et professionnels pour élargir les perspectives d’orientation, de mentorat et d’insertion des apprenants.</p>
          </div>
